      ...
      <div className="select-none overflow-x-hidden">
        ...
        <div className="relative z-40 bg-zinc-100 pb-24 dark:bg-zinc-800">
          ...
          {privilegeLevel == "admin" ? (
            <div className="flex justify-center">
              <Link
                className="z-100 mx-auto rounded border border-blue-500 bg-blue-400 px-4 py-2 text-white shadow-md transition-all duration-300 ease-in-out hover:bg-blue-500 active:scale-90 dark:border-blue-700 dark:bg-blue-700 dark:hover:bg-blue-800"
